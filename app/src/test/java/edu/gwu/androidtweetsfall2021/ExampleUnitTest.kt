...
class ExampleUnitTest {
    ...
    fun testSearchTweetsResponse() {
        val parser = SearchTweetsResponseParser()
        val result = parser.parseJson(JSONObject(testJson))

        assertEquals(3, result.size)

        // We could do more fine-grained assertions as well (e.g. individual fields parsed correctly)
        // ...
    }
